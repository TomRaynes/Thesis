...
These distance data must be used as a benchmark by which the accuracy of any modelled estimates
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Mixed subsample of extracted detection frames capturing chimpanzees taken from
    both the manual and automated sample. These show a variety of differnt scencarios including
    frames of minimally occluded individuals, distant individuals occluded by many layers of foliage,
    individuals at extreme close distances, individuals who are carrying another individual as well
    as an example of a low-quality frame resulting from moisture on the camera lense.}
...
\begin{figure}[htbp]
    ...
    \caption{Mixed subsample of frames taken exclusively from the automated sample, showing detection
    frames that capture no individuals. Frames such as these are present only in the automated
    frame sample, due to sampling of all video regardless of manual annotation.}
