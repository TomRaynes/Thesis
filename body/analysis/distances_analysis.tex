...
\begin{figure}[p]
    ...
    \caption{Graphs showing all modelled distance estimates mapped to thier corresponding manual
        ...
        Anything estimates tends to be below the ideal. This aligns with the results seen in
...
\begin{figure}[H]
    ...
    \caption{Graph showing the mean average error (MAE) of all distance estimates associated with
        ...
        It is seen that, after approximetely ten reference frame, minimal change in
        error is occurring.}
