...
where a monocular depth estimation (MDE) pipeline was applied to a camera trap dataset to obtain detection
distance estimates which were subsequently used to model the density and abundance of the local population.
Estimates derived using two MDE models (DPT and Depth Anything) with two pixel depth sampling methods were
